      ...
      <section className="bg-white dark:bg-zinc-900 rounded-xl shadow-sm p-5">
        ...
        <div className="flex items-baseline gap-2">
          <input
            ...
            className="w-24 px-3 py-1.5 border border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 rounded-md text-sm text-right focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
